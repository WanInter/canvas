                            ...
                            <section className="mb-5 mt-4 rounded-xl border border-stone-200 bg-stone-50/70 p-3 dark:border-stone-800 dark:bg-stone-900/50">
                                ...
                                {userStorage.enabled ? (
                                    <div className="mt-3 grid gap-3 md:grid-cols-2">
                                        ...
                                        <Segmented block options={[{ label: "路径寻址", value: "path" }, { label: "虚拟主机", value: "virtual" }]} value={userStorage.addressingStyle} onChange={(addressingStyle) => setUserStorage((value) => ({ ...value, addressingStyle: addressingStyle === "virtual" ? "virtual" : "path" }))} />
